...
- Create Angular project with ng: `ng new event_booking_and_management.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`event_booking_and_management.client.esproj`).
